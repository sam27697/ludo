...
PATTERNS = [
    ...
    # Catches the tool-authorship trailer line only: at the start of a line
    # (after any leading punctuation, as in a comment marker), or followed by
    # a link opener. Ordinary prose using the same verb phrase mid-sentence,
    # e.g. "output generated by the fixed script", does not match.
    ("trailer", r"(?:^\W*generated (?:with|by)\b|\bgenerated (?:with|by)\s*(?:\[|\(|<|https?://))"),
